...
# **Q&A**
# 
# Q. I noticed in today's lecture the command `echo` was used, I'm just curious what is the difference between using `echo` and `print()` ?  
# A. Great question! `echo` is the bash shell command; `print()` is the python command, but they do a very similar thing!  
# 
# Q. How can I distinguish whether it is a file or directory when I am in the terminal?  
# A. Another great question! Different terminals will use different color-schemes, making folders one color and files another. Another way to tell is the extension at the end of the file/folder. No extension, likely a folder. An extension (like .py, .ipynb, .md, .txt, etc.) there? Then it's likely a file
# 
# Q. Can we do more examples?  
# A. Yes! This will not be the last of it!
